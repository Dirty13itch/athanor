...
- Local dirty sample: ` M docs/architecture/ATHANOR-ECOSYSTEM-SYSTEM-BIBLE.md`, ` M docs/operations/ATHANOR-ECOSYSTEM-MASTER-PLAN.md`, ` M docs/operations/ATHANOR-FULL-SYSTEM-AUDIT.md`
