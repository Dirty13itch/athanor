...
| --- | --- | --- | --- | --- | --- |
| `1` | `reference-and-archive-prune` | `cash_now` | `23` | `archive_or_reference` | `startup-docs-and-prune, validation-and-publication` |
| `2` | `operator-tooling-and-helper-surfaces` | `cash_now` | `5` | `operator_tooling` | `authority-and-mainline, startup-docs-and-prune` |
| `3` | `audit-and-eval-artifacts` | `cash_now` | `2` | `audit_artifact` | `validation-and-publication, startup-docs-and-prune` |
...
- `docs/archive/research/2026-02-15-base-platform.md`
- `docs/archive/research/2026-02-15-creative-pipeline.md`
- `docs/archive/research/2026-02-15-home-automation.md`
- `docs/archive/research/2026-02-15-inference-engine.md`
- `docs/archive/research/2026-02-15-media-stack.md`
- `docs/archive/research/2026-02-15-monitoring.md`
- `docs/archive/research/2026-02-15-network-architecture.md`
...
Sample paths:
- `.claude/scratch/AGENT-AUDIT-REPORT.md`
- `.claude/scratch/DISCOVERY.md`
- `.claude/scratch/SECTION-C-COCHANGE.md`
- `.gitignore`
- `setup.ps1`
