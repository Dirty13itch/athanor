...
| `vault_provider_specific_api_observed` | 6 |
...
| Failure class | Count |
| --- | --- |
| `auth_surface_mismatch` | 1 |
| `present_key_invalid` | 3 |
...
| `google_gemini_api` | `vault_provider_specific_auth_failed` | `present_key_invalid` | `metered_api` | Use [VAULT-LITELLM-AUTH-REPAIR-PACKET.md](/C:/Athanor/docs/operations/VAULT-LITELLM-AUTH-REPAIR-PACKET.md) to repair `Gemini API` on VAULT, then re-probe served model `gemini`. |
| `openai_api` | `vault_provider_specific_auth_failed` | `present_key_invalid` | `metered_api` | Use [VAULT-LITELLM-AUTH-REPAIR-PACKET.md](/C:/Athanor/docs/operations/VAULT-LITELLM-AUTH-REPAIR-PACKET.md) to repair `OpenAI API` on VAULT, then re-probe served model `gpt`. |
| `openrouter_api` | `vault_provider_specific_auth_failed` | `present_key_invalid` | `metered_api` | Use [VAULT-LITELLM-AUTH-REPAIR-PACKET.md](/C:/Athanor/docs/operations/VAULT-LITELLM-AUTH-REPAIR-PACKET.md) to repair `OpenRouter API` on VAULT, then re-probe served model `openrouter`. |
...
| `anthropic_api` | api | api | `active-api`, `configured-unused` | none | unverified or metered | metered | vault_provider_specific_api_observed |
...
- Observed runtime: `routing_policy_enabled=False`, `active_burn_observed=False`, `api_configured=True`, `proxy_activity_observed=True`, `provider_specific_usage_observed=True`, `last_verified_at=2026-04-08T05:48:41Z`, `provider_usage_capture_status=observed`, `provider_usage_capture_at=2026-04-14T00:51:19Z`, `provider_usage_capture_source=vault-litellm-live-probe`
- Evidence contract: `kind=vault_litellm_proxy`, `alias=claude`, `host=vault`, `preferred_model=claude`, `provider_specific_status=observed`, `capture_status=observed`, `captured_at=2026-04-14T00:51:19Z`, `requested_model=claude`, `response_model=claude`, `matched_by=preferred_exact`
- Runtime env audit: missing none, present `ANTHROPIC_API_KEY`, audit `2026-04-14T21:50:45Z`
- Tool evidence: none
- Next verification: No immediate verification gap recorded.
- Verification steps: `No immediate verification gap recorded.`
...
- Env contracts: `ANTHROPIC_API_KEY`
- CLI commands: none
- Notes: `The 2026-04-08 live VAULT provider probe now succeeds through the `claude` compatibility alias after the governed LiteLLM config reconcile restored the served-model contract.`
...
- Burn windows: none
- Observed hosts: `vault`
- Observed runtime: `routing_policy_enabled=False`, `active_burn_observed=False`, `api_configured=True`, `proxy_activity_observed=True`, `provider_specific_usage_observed=False`, `last_verified_at=2026-04-08T05:24:28Z`, `provider_usage_capture_status=auth_failed`, `provider_usage_capture_at=2026-04-14T00:51:24Z`, `provider_usage_capture_source=vault-litellm-live-probe`
- Evidence contract: `kind=vault_litellm_proxy`, `alias=gpt`, `host=vault`, `preferred_model=gpt`, `provider_specific_status=auth_failed`, `capture_status=auth_failed`, `captured_at=2026-04-14T00:51:24Z`, `requested_model=gpt`, `matched_by=preferred_exact`
- Runtime env audit: missing none, present `OPENAI_API_KEY`, audit `2026-04-14T21:50:45Z`
- Tool evidence: none
...
- Burn windows: none
- Observed hosts: `vault`
- Observed runtime: `routing_policy_enabled=False`, `active_burn_observed=False`, `api_configured=True`, `proxy_activity_observed=True`, `provider_specific_usage_observed=True`, `last_verified_at=2026-04-08T05:24:28Z`, `provider_usage_capture_status=observed`, `provider_usage_capture_at=2026-04-14T00:51:21Z`, `provider_usage_capture_source=vault-litellm-live-probe`
- Evidence contract: `kind=vault_litellm_proxy`, `alias=codestral`, `host=vault`, `preferred_model=codestral`, `provider_specific_status=observed`, `capture_status=observed`, `captured_at=2026-04-14T00:51:21Z`, `requested_model=codestral`, `response_model=codestral`, `matched_by=preferred_exact`
- Runtime env audit: missing none, present `CODESTRAL_API_KEY`, `MISTRAL_API_KEY`, audit `2026-04-14T21:50:45Z`
- Tool evidence: none
- Next verification: No immediate verification gap recorded.
- Verification steps: `No immediate verification gap recorded.`
...
- Burn windows: none
- Observed hosts: `vault`
- Observed runtime: `routing_policy_enabled=False`, `active_burn_observed=False`, `api_configured=True`, `proxy_activity_observed=True`, `provider_specific_usage_observed=False`, `last_verified_at=2026-04-08T00:08:32Z`, `provider_usage_capture_status=auth_failed`, `provider_usage_capture_at=2026-04-14T00:51:21Z`, `provider_usage_capture_source=vault-litellm-live-probe`
- Evidence contract: `kind=vault_litellm_proxy`, `alias=gemini`, `host=vault`, `preferred_model=gemini`, `provider_specific_status=auth_failed`, `capture_status=auth_failed`, `captured_at=2026-04-14T00:51:21Z`, `requested_model=gemini`, `matched_by=preferred_exact`
- Runtime env audit: missing none, present `GEMINI_API_KEY`, `GOOGLE_API_KEY`, audit `2026-04-14T21:50:45Z`
- Tool evidence: none
...
- Burn windows: none
- Observed hosts: `vault`
- Observed runtime: `routing_policy_enabled=False`, `active_burn_observed=False`, `api_configured=True`, `proxy_activity_observed=True`, `provider_specific_usage_observed=True`, `last_verified_at=2026-04-08T00:08:31Z`, `provider_usage_capture_status=observed`, `provider_usage_capture_at=2026-04-14T00:51:21Z`, `provider_usage_capture_source=vault-litellm-live-probe`
- Evidence contract: `kind=vault_litellm_proxy`, `alias=deepseek`, `host=vault`, `preferred_model=deepseek`, `provider_specific_status=observed`, `capture_status=observed`, `captured_at=2026-04-14T00:51:21Z`, `requested_model=deepseek`, `response_model=deepseek`, `matched_by=preferred_exact`
- Runtime env audit: missing none, present `DEEPSEEK_API_KEY`, audit `2026-04-14T21:50:45Z`
- Tool evidence: none
- Next verification: No immediate verification gap recorded.
- Verification steps: `No immediate verification gap recorded.`
...
- CLI commands: none
- Notes: `DeepSeek is configured as an API lane via LiteLLM.`, `Provider-specific completion proof is current through 2026-04-08.`
...
- Burn windows: none
- Observed hosts: `vault`
- Observed runtime: `routing_policy_enabled=False`, `active_burn_observed=False`, `api_configured=True`, `proxy_activity_observed=True`, `provider_specific_usage_observed=True`, `last_verified_at=2026-04-08T05:24:28Z`, `provider_usage_capture_status=observed`, `provider_usage_capture_at=2026-04-14T00:51:24Z`, `provider_usage_capture_source=vault-litellm-live-probe`
- Evidence contract: `kind=vault_litellm_proxy`, `alias=kimi-k2.5`, `host=vault`, `preferred_model=kimi-k2.5`, `provider_specific_status=observed`, `capture_status=observed`, `captured_at=2026-04-14T00:51:24Z`, `requested_model=kimi-k2.5`, `response_model=kimi-k2.5`, `matched_by=preferred_exact`
- Runtime env audit: missing `MOONSHOT_API_KEY`, present none, audit `2026-04-14T21:50:45Z`
- Tool evidence: none
- Next verification: No immediate verification gap recorded.
- Verification steps: `No immediate verification gap recorded.`
...
- Burn windows: none
- Observed hosts: `vault`
- Observed runtime: `routing_policy_enabled=False`, `active_burn_observed=False`, `api_configured=True`, `proxy_activity_observed=True`, `provider_specific_usage_observed=False`, `last_verified_at=2026-04-08T05:24:28Z`, `provider_usage_capture_status=auth_failed`, `provider_usage_capture_at=2026-04-14T00:51:20Z`, `provider_usage_capture_source=vault-litellm-live-probe`
- Evidence contract: `kind=vault_litellm_proxy`, `alias=qwen-max`, `host=vault`, `preferred_model=qwen-max`, `provider_specific_status=auth_failed`, `capture_status=auth_failed`, `captured_at=2026-04-14T00:51:20Z`, `requested_model=qwen-max`, `matched_by=preferred_exact`
- Runtime env audit: missing `DASHSCOPE_API_KEY`, present none, audit `2026-04-14T21:50:45Z`
- Tool evidence: none
...
- Burn windows: none
- Observed hosts: `vault`
- Observed runtime: `routing_policy_enabled=False`, `active_burn_observed=False`, `api_configured=True`, `proxy_activity_observed=True`, `provider_specific_usage_observed=True`, `last_verified_at=2026-04-08T05:24:29Z`, `provider_usage_capture_status=observed`, `provider_usage_capture_at=2026-04-14T00:51:24Z`, `provider_usage_capture_source=vault-litellm-live-probe`
- Evidence contract: `kind=vault_litellm_proxy`, `alias=venice-uncensored`, `host=vault`, `preferred_model=venice-uncensored`, `provider_specific_status=observed`, `capture_status=observed`, `captured_at=2026-04-14T00:51:24Z`, `requested_model=venice-uncensored`, `response_model=venice-uncensored`, `matched_by=preferred_exact`
- Runtime env audit: missing none, present `VENICE_API_KEY`, audit `2026-04-14T21:50:45Z`
- Tool evidence: none
- Next verification: No immediate verification gap recorded.
- Verification steps: `No immediate verification gap recorded.`
...
- CLI commands: none
- Notes: `Venice remains configured as an API lane.`, `Provider-specific completion proof is current through 2026-04-08.`
...
- Burn windows: none
- Observed hosts: `vault`
- Observed runtime: `routing_policy_enabled=False`, `active_burn_observed=False`, `api_configured=True`, `proxy_activity_observed=True`, `provider_specific_usage_observed=True`, `last_verified_at=2026-04-13T00:03:44Z`, `provider_usage_capture_status=observed`, `provider_usage_capture_at=2026-04-14T00:51:25Z`, `provider_usage_capture_source=vault-litellm-live-probe`
- Evidence contract: `kind=vault_litellm_proxy`, `alias=glm-4.7`, `host=vault`, `preferred_model=glm-4.7`, `provider_specific_status=observed`, `capture_status=observed`, `captured_at=2026-04-14T00:51:25Z`, `requested_model=glm-4.7`, `response_model=glm-4.7`, `matched_by=preferred_exact`
- Runtime env audit: missing none, present `ZAI_API_KEY`, audit `2026-04-14T21:50:45Z`
- Tool evidence: none
- Next verification: No immediate verification gap recorded.
- Verification steps: `No immediate verification gap recorded.`
...
- CLI commands: none
- Notes: `The 2026-04-13 live VAULT provider probe now succeeds through the `glm-4.7` alias after restoring `ZAI_API_KEY` to the running LiteLLM container.`
...
- Observed hosts: `vault`
- Observed runtime: `routing_policy_enabled=False`, `active_burn_observed=False`, `api_configured=True`, `proxy_activity_observed=True`, `provider_specific_usage_observed=False`, `last_verified_at=2026-04-08T05:24:28Z`, `provider_usage_capture_status=auth_failed`, `provider_usage_capture_at=2026-04-14T00:51:24Z`, `provider_usage_capture_source=vault-litellm-live-probe`
- Evidence contract: `kind=vault_litellm_proxy`, `alias=openrouter`, `host=vault`, `preferred_model=openrouter`, `provider_specific_status=auth_failed`, `capture_status=auth_failed`, `captured_at=2026-04-14T00:51:24Z`, `requested_model=openrouter`, `matched_by=preferred_exact`
- Runtime env audit: missing none, present `OPENROUTER_API_KEY`, audit `2026-04-14T21:50:45Z`
- Tool evidence: none
