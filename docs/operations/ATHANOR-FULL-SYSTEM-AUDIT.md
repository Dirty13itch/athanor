...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `Athanor control plane and truth surfaces` | `adopted_live_system` | `4.6` | `5.0` | `4.0` | `4.0` | `5.0` | `low` | `medium` |
...
| `Operator communication and front-door UX` | `adopted_live_system` | `4.6` | `5.0` | `4.0` | `4.0` | `5.0` | `low` | `medium` |
