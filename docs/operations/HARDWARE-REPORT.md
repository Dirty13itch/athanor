...
- Evidence sources: `ssh runtime probe`
- Notes: `Primary high-throughput inference node.`, `Observed model endpoints currently serve Qwen3.5-27B-FP8 on 8000 and devstral-small-2 on 8006.`
...
- Evidence sources: `ssh runtime probe`
- Notes: `ComfyUI on 8188 is observed on the 5060 Ti lane.`, `The 8010 lane is aligned to the canonical workshop worker runtime and currently serves /models/Qwen3.5-35B-A3B-AWQ-4bit.`
