...
- Cached redis audit: `2026-04-16T22:16:29Z`
...
- Redis data directory size: `54.77 MiB`
- Filesystem device: `/dev/nvme0n1p1`
- Filesystem size: `931.51 GiB`
- Filesystem used: `495.23 GiB`
- Filesystem available: `434.33 GiB`
...
- Btrfs free estimate: `434.33GiB	(min: 248.60GiB)`
...
- `/mnt/appdatacache/n8n`: `357.35 MiB`
- `/mnt/appdatacache/miniflux-postgres`: `173.26 MiB`
...
- `/mnt/appdatacache/appdata/sonarr`: `1008.10 MiB`
