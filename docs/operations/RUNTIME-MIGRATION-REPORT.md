...
- Live content evidence snapshot: `2026-03-30T00:04:37.657861+00:00`
...
| `4` | `services/gateway/main.py` | `migrated` | `cutover_verified` | `backup_then_replace_from_implementation_authority` | `/home/shaun/repos/athanor/services/gateway/main.py` | `content_drift` | `/home/shaun/.athanor/backups/governor-facade-cutover/services/gateway/main.py` | `False` | `True` |
| `5` | `services/governor/status_report.py` | `migrated` | `cutover_verified` | `backup_then_replace_from_implementation_authority` | `/home/shaun/repos/athanor/services/governor/status_report.py` | `content_drift` | `/home/shaun/.athanor/backups/governor-facade-cutover/services/governor/status_report.py` | `False` | `True` |
| `6` | `services/governor/overnight.py` | `migrated` | `cutover_verified` | `backup_then_replace_from_implementation_authority` | `/home/shaun/repos/athanor/services/governor/overnight.py` | `content_drift` | `/home/shaun/.athanor/backups/governor-facade-cutover/services/governor/overnight.py` | `False` | `True` |
| `7` | `services/governor/act_first.py` | `migrated` | `cutover_verified` | `backup_then_replace_from_implementation_authority` | `/home/shaun/repos/athanor/services/governor/act_first.py` | `content_drift` | `/home/shaun/.athanor/backups/governor-facade-cutover/services/governor/act_first.py` | `False` | `True` |
| `8` | `services/governor/self_improve.py` | `migrated` | `cutover_verified` | `backup_then_replace_from_implementation_authority` | `/home/shaun/repos/athanor/services/governor/self_improve.py` | `content_drift` | `/home/shaun/.athanor/backups/governor-facade-cutover/services/governor/self_improve.py` | `False` | `True` |
| `9` | `services/sentinel/checks.py` | `migrated` | `cutover_verified` | `backup_then_replace_from_implementation_authority` | `/home/shaun/repos/athanor/services/sentinel/checks.py` | `content_drift` | `/home/shaun/.athanor/backups/governor-facade-cutover/services/sentinel/checks.py` | `False` | `True` |
...
| --- | --- | --- | --- | --- | --- | --- |
| `1` | `scripts/drift-check.sh` | `backup_then_replace_runtime_copy` | `C:\Athanor\.worktrees\truth-backbone\scripts\drift-check.sh` | `/home/shaun/repos/athanor/scripts/drift-check.sh` | `/home/shaun/.athanor/backups/governor-facade-cutover/scripts/drift-check.sh` | `True` |
| `2` | `scripts/smoke-test.sh` | `backup_then_replace_runtime_copy` | `C:\Athanor\.worktrees\truth-backbone\scripts\smoke-test.sh` | `/home/shaun/repos/athanor/scripts/smoke-test.sh` | `/home/shaun/.athanor/backups/governor-facade-cutover/scripts/smoke-test.sh` | `True` |
| `3` | `services/cluster_config.py` | `backup_then_replace_runtime_copy` | `C:\Athanor\.worktrees\truth-backbone\services\cluster_config.py` | `/home/shaun/repos/athanor/services/cluster_config.py` | `/home/shaun/.athanor/backups/governor-facade-cutover/services/cluster_config.py` | `True` |
| `4` | `services/gateway/main.py` | `backup_then_replace_runtime_copy` | `C:\Athanor\.worktrees\truth-backbone\services\gateway\main.py` | `/home/shaun/repos/athanor/services/gateway/main.py` | `/home/shaun/.athanor/backups/governor-facade-cutover/services/gateway/main.py` | `True` |
| `5` | `services/governor/status_report.py` | `backup_then_replace_runtime_copy` | `C:\Athanor\.worktrees\truth-backbone\services\governor\status_report.py` | `/home/shaun/repos/athanor/services/governor/status_report.py` | `/home/shaun/.athanor/backups/governor-facade-cutover/services/governor/status_report.py` | `True` |
| `6` | `services/governor/overnight.py` | `backup_then_replace_runtime_copy` | `C:\Athanor\.worktrees\truth-backbone\services\governor\overnight.py` | `/home/shaun/repos/athanor/services/governor/overnight.py` | `/home/shaun/.athanor/backups/governor-facade-cutover/services/governor/overnight.py` | `True` |
| `7` | `services/governor/act_first.py` | `backup_then_replace_runtime_copy` | `C:\Athanor\.worktrees\truth-backbone\services\governor\act_first.py` | `/home/shaun/repos/athanor/services/governor/act_first.py` | `/home/shaun/.athanor/backups/governor-facade-cutover/services/governor/act_first.py` | `True` |
| `8` | `services/governor/self_improve.py` | `backup_then_replace_runtime_copy` | `C:\Athanor\.worktrees\truth-backbone\services\governor\self_improve.py` | `/home/shaun/repos/athanor/services/governor/self_improve.py` | `/home/shaun/.athanor/backups/governor-facade-cutover/services/governor/self_improve.py` | `True` |
| `9` | `services/sentinel/checks.py` | `backup_then_replace_runtime_copy` | `C:\Athanor\.worktrees\truth-backbone\services\sentinel\checks.py` | `/home/shaun/repos/athanor/services/sentinel/checks.py` | `/home/shaun/.athanor/backups/governor-facade-cutover/services/sentinel/checks.py` | `True` |
...
- Implementation file: `C:\Athanor\.worktrees\truth-backbone\scripts\drift-check.sh`
...
- Runtime lines: `226`
- Implementation hash: `4f4c6a00d39d`
- Implementation size: `7327` bytes
...
- Runtime file exists: `True`
- Runtime target matches registry: `True`
- Implementation file: `C:\Athanor\.worktrees\truth-backbone\scripts\smoke-test.sh`
- Implementation file exists: `True`
- Live content sync: `content_drift`
- Live `:8760` reference observed: `False`
...
- Runtime lines: `51`
- Implementation hash: `d26dbacb64f9`
- Implementation size: `2038` bytes
...
- Runtime file exists: `True`
- Runtime target matches registry: `True`
- Implementation file: `C:\Athanor\.worktrees\truth-backbone\services\cluster_config.py`
- Implementation file exists: `True`
- Live content sync: `content_drift`
- Live `:8760` reference observed: `False`
...
- Runtime lines: `138`
- Implementation hash: `b926de296a0f`
- Implementation size: `3842` bytes
- Implementation lines: `81`
...
- Runtime file exists: `True`
- Runtime target matches registry: `True`
- Implementation file: `C:\Athanor\.worktrees\truth-backbone\services\gateway\main.py`
- Implementation file exists: `True`
- Live content sync: `content_drift`
- Live `:8760` reference observed: `False`
...
- Runtime lines: `152`
- Implementation hash: `e499a4dffece`
- Implementation size: `3288` bytes
- Implementation lines: `94`
- Notes: none
...
- Runtime file exists: `True`
- Runtime target matches registry: `True`
- Implementation file: `C:\Athanor\.worktrees\truth-backbone\services\governor\status_report.py`
- Implementation file exists: `True`
- Live content sync: `content_drift`
- Live `:8760` reference observed: `False`
...
- Runtime lines: `105`
- Implementation hash: `cf1a0cfcd9dd`
- Implementation size: `4158` bytes
- Implementation lines: `93`
- Notes: none
...
- Runtime file exists: `True`
- Runtime target matches registry: `True`
- Implementation file: `C:\Athanor\.worktrees\truth-backbone\services\governor\overnight.py`
- Implementation file exists: `True`
- Live content sync: `content_drift`
- Live `:8760` reference observed: `False`
...
- Runtime lines: `124`
- Implementation hash: `a1c0b32de175`
- Implementation size: `2954` bytes
- Implementation lines: `90`
- Notes: none
...
- Runtime file exists: `True`
- Runtime target matches registry: `True`
- Implementation file: `C:\Athanor\.worktrees\truth-backbone\services\governor\act_first.py`
- Implementation file exists: `True`
- Live content sync: `content_drift`
- Live `:8760` reference observed: `False`
...
- Runtime lines: `79`
- Implementation hash: `fa2b0aabf4ff`
- Implementation size: `2772` bytes
- Implementation lines: `77`
- Notes: none
...
- Runtime file exists: `True`
- Runtime target matches registry: `True`
- Implementation file: `C:\Athanor\.worktrees\truth-backbone\services\governor\self_improve.py`
- Implementation file exists: `True`
- Live content sync: `content_drift`
- Live `:8760` reference observed: `False`
...
- Runtime lines: `163`
- Implementation hash: `19541103ade7`
- Implementation size: `4920` bytes
...
- Runtime file exists: `True`
- Runtime target matches registry: `True`
- Implementation file: `C:\Athanor\.worktrees\truth-backbone\services\sentinel\checks.py`
- Implementation file exists: `True`
- Live content sync: `content_drift`
- Live `:8760` reference observed: `False`
...
- Runtime lines: `282`
- Implementation hash: `f2e4592df4a5`
- Implementation size: `9972` bytes
- Implementation lines: `272`
- Notes: none
