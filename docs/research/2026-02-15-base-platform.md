...
This decision governs the compute nodes. VAULT (Unraid) and DEV (Windows) are fixed — their role in the full system is addressed in ADR-002 through ADR-004. The full hardware inventory is in `docs/hardware/inventory.md`.
