# Credential Rotation Reference Runbook
...
Mutable facts policy: affected services, host placement, and auth classes come from the topology registry. This runbook documents the operator sequence for rotating credentials without reintroducing tracked secret values.
