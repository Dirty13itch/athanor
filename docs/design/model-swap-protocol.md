...
1. **Idle state:** vLLM has Qwen3-14B loaded on the 5090 (GPU 0). ComfyUI has no model loaded on GPU 1 (5060 Ti is dedicated to Flux dev FP8).
...
4. **Concurrent chat during generation:** Routes to Node 1 (TP=4 Qwen3-32B-AWQ) instead. The supervisor knows the 5090 is busy and diverts interactive chat to Node 1.
...
|-----|--------|-------------|------|
| 0 | RTX 5090 | vLLM (Qwen3-14B) | 32 GB |
