...
| **Proficiency** | Expert |
| **Artifacts** | `CONSTITUTION.yaml` autonomy spectrum, escalation protocol, `STATUS.md`, `docs/operations/CONTINUOUS-COMPLETION-BACKLOG.md` |
...
| **Proficiency** | Expert |
| **Artifacts** | `STATUS.md`, `docs/operations/CONTINUOUS-COMPLETION-BACKLOG.md`, `docs/design/athanor-next.md` (program tracks), MEMORY.md (session continuity) |
| **Sub-skills** | Dependency graphing, priority ranking, blocker tracking, progress reporting, scope management |
| **Tools** | `STATUS.md`, `docs/operations/CONTINUOUS-COMPLETION-BACKLOG.md`, MEMORY.md, plan files |
| **Gap** | No visualization of the dependency graph. No automated progress tracking beyond manual status/backlog updates. |
...
| **Proficiency** | Expert |
| **Sub-skills** | ADR authoring (21+), research documentation, SYSTEM-SPEC maintenance, live backlog tracking, MEMORY.md session continuity, cross-repo reference checking |
...
- Add top gaps to `STATUS.md` and `docs/operations/CONTINUOUS-COMPLETION-BACKLOG.md` as ranked follow-through items
