...
>
> Active planning and intent-mining code now reads [`docs/operations/CONTINUOUS-COMPLETION-BACKLOG.md`](../operations/CONTINUOUS-COMPLETION-BACKLOG.md)
> and [`STATUS.md`](../../STATUS.md) instead of this file.

*This archived manifest is historical backlog context only. `docs/design/athanor-next.md` is a strategic reference above it, but current autonomous build sessions should use `STATUS.md` and `docs/operations/CONTINUOUS-COMPLETION-BACKLOG.md` instead of this file.*
...
1. Runtime code, live-defining config, audited inventory, and deployed manifests
2. Atlas and current-state docs that synthesize the live system
...
- **Routes (historical deployment note):** the current alias map is documented in `docs/SERVICES.md` and `docs/SYSTEM-SPEC.md`
...
- **Status:** ✅ (Session 8, 2026-02-24)
- **Deployed:** VAULT:6333 (REST), VAULT:6334 (gRPC)
...
- **Research:** `docs/archive/research/2026-02-24-voice-interaction.md` — faster-whisper + Kokoro TTS + Piper (HA) + openWakeWord
...
- **Research:** `docs/archive/research/2026-02-24-remote-access.md` — 5 options evaluated (historical)
