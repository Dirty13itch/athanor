...
| `../archive/research/2026-02-25-cloud-coding-api-cascade.md` | — | Sonnet 4.6 as primary cloud tier |

### Hardware Audits (5 nodes)
| File | Key Finding |
|------|------------|
| `docs/archive/hardware/2026-02-25-node1-deep-audit.md` | Historical Node 1 discrepancy audit: GPU power caps, unmounted NVMe, channel H empty |
| `docs/archive/hardware/2026-02-25-node2-deep-audit.md` | Historical Node 2 discrepancy audit: DDR5 at 4800, 3TB Gen5 unused, 5060 Ti x8 |
| `docs/archive/hardware/2026-02-25-vault-deep-audit.md` | Historical VAULT audit: ~~Qdrant backups EMPTY~~ (resolved later), array 90%, 15 containers |
| `docs/archive/hardware/2026-02-25-dev-network-audit.md` | Historical DEV/network discrepancy audit from the pre-registry phase |
