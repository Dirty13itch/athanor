...
3. Use `docs/operations/ATHANOR-LAYERED-MASTER-PLAN.md` as the Athanor-core planning entrypoint instead of reopening flat roadmap docs.
4. Use `docs/operations/ATHANOR-ECOSYSTEM-MASTER-PLAN.md` and `docs/operations/ATHANOR-OPERATOR-MODEL.md` for cross-system planning and operator truth.
5. Use `docs/operations/ATHANOR-ECOSYSTEM-DEPENDENCY-MAP.md` when lane order depends on provider, substrate, devstack, or approval gates.
6. Start new sessions with `python scripts/session_restart_brief.py --refresh` before choosing a lane.
7. Treat publication as a triage task first, not a blind commit:
...
8. Treat the new reconciliation control surface as canonical for cross-repo and side-root work:
