...
*This is the tactical execution queue and historical backlog. `docs/design/athanor-next.md` is a strategic reference above it. Claude Code may use this file to decide what to build next, but it does not define topology, routing, or governance.*
