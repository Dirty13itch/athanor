...
ENDPOINTS = [
    ("/health", "health"),
    ("/v1/models", "catalog"),
    ("/v1/system-map", "command-hierarchy"),
    ("/v1/governor", "command-hierarchy"),
    ("/v1/models/governance", "model-governance"),
    ("/v1/models/proving-ground", "model-governance"),
    ("/v1/review/judges", "model-governance"),
    ("/v1/agents", "catalog"),
    ...
    ("/v1/subscriptions/summary", "subscriptions"),
    ("/v1/subscriptions/execution", "subscriptions"),
    ("/v1/subscriptions/handoffs", "subscriptions"),
