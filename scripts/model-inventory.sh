...
VAULT_HOST="${ATHANOR_VAULT_HOST:-${VAULT_IP}}"
FOUNDRY_HOST="${ATHANOR_NODE1_HOST:-${FOUNDRY_IP}}"
WORKSHOP_HOST="${ATHANOR_NODE2_HOST:-${WORKSHOP_IP}}"
DEV_HOST="${ATHANOR_DEV_HOST:-${DEV_IP}}"
