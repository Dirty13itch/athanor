    ...
    def test_canonical_athanor_env_aliases_are_supported(self) -> None:
        with patch.dict(
            os.environ,
            {
                ...
                "ATHANOR_VLLM_WORKER_URL": "http://workshop:8000",
        ...
        self.assertEqual(settings.vllm_node2_url, "http://workshop:8000")
    ...
    def test_legacy_gpu_orchestrator_env_names_still_work(self) -> None:
        with patch.dict(
            os.environ,
            {
                ...
                "GPU_ORCH_VLLM_NODE2_URL": "http://legacy-workshop:8000",
        ...
        self.assertEqual(settings.vllm_node2_url, "http://legacy-workshop:8000")
