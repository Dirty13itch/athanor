...
const WORKFLOW_TEMPLATES: Record<string, Record<string, unknown>> = {
  character: {
    ...
    "7": { class_type: "KSampler", inputs: { model: ["1", 0], seed: 42, steps: 25, cfg: 1.0, sampler_name: "euler", scheduler: "simple", positive: ["4", 0], negative: ["5", 0], latent_image: ["6", 0], denoise: 1.0 } },
  ...
  scene: {
    ...
    "7": { class_type: "KSampler", inputs: { model: ["1", 0], seed: 123, steps: 25, cfg: 1.0, sampler_name: "euler", scheduler: "simple", positive: ["4", 0], negative: ["5", 0], latent_image: ["6", 0], denoise: 1.0 } },
    "8": { class_type: "VAELoader", inputs: { vae_name: "ae.safetensors" } },
    "9": { class_type: "VAEDecode", inputs: { samples: ["7", 0], vae: ["8", 0] } },
