...
export type SectionId = "pulse" | "crew" | "gpus" | "workloads" | "stream" | "watches" | "links" | "digest";
...
export const LENS_CONFIG: Record<LensId, LensConfig> = {
  default: {
    ...
    accentHue: 65,
    agents: [],
    sections: ["pulse", "crew", "gpus", "workloads", "stream", "watches", "links", "digest"],
    streamFilter: [],
    navHighlight: [],
  },
  system: {
    ...
    sections: ["pulse", "gpus", "workloads", "crew", "stream", "links", "digest"],
  ...
  media: {
    ...
    accentHue: 160,
    agents: ["media-agent"],
    sections: ["pulse", "watches", "crew", "stream", "workloads", "gpus", "links", "digest"],
  ...
  creative: {
    ...
    sections: ["pulse", "crew", "workloads", "gpus", "stream", "links", "digest"],
  ...
  eoq: {
    ...
    sections: ["pulse", "crew", "stream", "workloads", "gpus", "links", "digest"],
    streamFilter: ["task", "agent"],
