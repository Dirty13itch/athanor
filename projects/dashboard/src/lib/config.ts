export const config = {
  ...
  vllm: {
    url: process.env.NEXT_PUBLIC_VLLM_URL ?? "http://192.168.1.244:8000",
    chatEndpoint: "/v1/chat/completions",
    modelsEndpoint: "/v1/models",
  },
  services: [
    { name: "vLLM", url: "http://192.168.1.244:8000/v1/models", node: "Node 1" },
  ...
  nodes: [
    ...
    { name: "Node 2 (interface)", ip: "192.168.1.225", role: "GPU creative" },
