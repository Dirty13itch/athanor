...
const fixtureModelDescriptions: Record<string, string> = {
  ...
  creative: "LiteLLM alias for creative text work routed through the canonical shared proxy lanes.",
  utility: "LiteLLM alias for fast utility work routed through the canonical shared proxy lanes.",
  fast: "LiteLLM alias for fast interactive work routed through the canonical shared proxy lanes.",
  worker: "Legacy delegated worker alias retained for historical compatibility, not an active Workshop lane.",
  uncensored: "Legacy uncensored alias retained for historical compatibility, not an active Workshop lane.",
...
> = {
  ...
  "ulrich-energy": {
    description: "Business-ops tenant focused on field scheduling, proof tracking, and admin obligations.",
    agents: ["general-assistant"],
    needsCount: 2,
    constraints: [
      "Prefer schedule and proof truth over speculative CRM expansion.",
      "Keep administrative obligations visible without turning the lane into a generic dashboard.",
    ],
    mappedAgents: 1,
    totalTasks: 2,
    pendingTasks: 1,
...
const fixtureWorkforce: WorkforceSnapshot = {
  ...
  tasks: [
    ...
    },
    {
      ...
      requiresApproval: false,
      reviewId: null,
      resultId: "builder-result:task-ath-brief",
      source: "work_planner",
      projectId: "athanor",
      planId: "wp-1741524000",
      rationale: "Provides a high-signal operating summary for the day.",
    ...
    },
    {
      ...
      requiresApproval: false,
      reviewId: null,
      resultId: "builder-result:task-kindred-1",
      source: "work_planner",
      projectId: "kindred",
      planId: "wp-1741524000",
      rationale: "Keeps the scaffolded tenant warm without distracting from active builds.",
    ...
    },
    {
      ...
      requiresApproval: false,
      reviewId: null,
      resultId: "builder-result:task-media-1",
      source: "work_planner",
      projectId: "media",
      planId: "wp-1741524000",
      rationale: "Maintains the media stack without adding low-value churn.",
...
const fixtureOverview: OverviewSnapshot = {
  ...
  navAttention: buildNavAttentionSignals({
    ...
    builder: {
      ...
      current_session: {
        id: "builder-fixture-1",
        title: "Implement the first builder front-door Codex route",
        ...
        updated_at: isoMinutesBefore(FIXTURE_BASE_TIME, 18),
      },
      sessions: [],
    },
  ...
  builderFrontDoor: {
    ...
    sessions: [
      ...
      {
        id: "builder-fixture-0",
        title: "Draft the builder front door rollout contract",
        status: "completed",
        primary_adapter: "codex",
        current_route: "Codex direct implementation",
        ...
        artifact_count: 2,
        resumable_handle: "019d-builder-fixture-thread",
        shadow_mode: false,
        fallback_state: null,
        updated_at: isoMinutesBefore(FIXTURE_BASE_TIME, 160),
      },
    ],
  },
  executiveKernel: {
    ...
    active_family: "builder",
    active_session_count: 1,
    active_program_count: 2,
    running_program_count: 1,
    local_protected_reserve_count: 2,
    local_harvestable_slot_count: 2,
    open_harvest_slot_count: 1,
    provider_reserve_posture: "balanced",
    constrained_provider_count: 1,
    current_session: {
      family: "builder",
      id: "builder-fixture-1",
      title: "Implement the first builder front-door Codex route",
  ...
  activity: [
    {
      ...
      resultId: null,
      status: "pending_approval",
      href: "/review?selection=approval%3Atask-eoq-1",
    },
    {
      id: "activity-2",
      agentId: "creative-agent",
...
const fixtureReviewItems: ReviewSnapshot["reviewItems"] = [
  {
    id: "approval:task-eoq-1",
    kind: "approval",
    taskId: "task-eoq-1",
    reviewId: "approval:task-eoq-1",
    resultId: null,
    ...
    recoveryGate: null,
    error: null,
    deepLink: "/review?selection=approval%3Atask-eoq-1",
  },
  {
    ...
    recoveryGate: null,
    error: null,
    deepLink: "/review?selection=approval%3Atask-home-1",
  },
  {
    id: "builder-result:task-ath-brief",
    kind: "result",
    taskId: "task-ath-brief",
    reviewId: null,
    resultId: "builder-result:task-ath-brief",
    projectId: "athanor",
    agentId: "general-assistant",
    ...
    requiresApproval: false,
    source: "work_planner",
    resultSummary: "Morning brief published with service drift, GPU hotspot, and queue notes.",
    resultOutcome: "succeeded",
    resultVerificationStatus: "passed",
    resultArtifacts: [],
    resultFilesChanged: [],
    resultValidation: [],
    remainingRisks: [],
    ...
    recoveryGate: null,
    error: null,
    deepLink: "/builder?session=task-ath-brief",
  },
  {
    id: "builder-result:task-kindred-1",
    kind: "result",
    taskId: "task-kindred-1",
    reviewId: null,
    resultId: "builder-result:task-kindred-1",
    ...
    requiresApproval: false,
    source: "work_planner",
    resultSummary: "Research memo recorded with three adjacent product patterns and open questions.",
    resultOutcome: "succeeded",
    resultVerificationStatus: "passed",
    resultArtifacts: [],
    resultFilesChanged: [],
    ...
    recoveryGate: null,
    error: null,
    deepLink: "/builder?session=task-kindred-1",
  },
  {
    id: "builder-result:task-media-1",
    kind: "result",
    taskId: "task-media-1",
    reviewId: null,
    resultId: "builder-result:task-media-1",
    ...
    requiresApproval: false,
    source: "work_planner",
    resultSummary: "Sonarr queue hydration failed and needs operator review.",
    resultOutcome: "failed",
    resultVerificationStatus: "failed",
    resultArtifacts: [],
    resultFilesChanged: [],
    resultValidation: [],
    remainingRisks: ["Media queue state unresolved"],
    resumableHandle: null,
    recoveryGate: "resume_available",
    error: null,
    deepLink: "/builder?session=task-media-1",
  },
];

const fixtureReviewTasks = fixtureWorkforce.tasks.filter((task) =>
  ["pending_approval", "failed", "completed"].includes(task.status)
);

const fixtureReviewSnapshot: ReviewSnapshot = {
  generatedAt: fixtureIntelligenceSnapshot.generatedAt,
  projects: fixtureIntelligenceSnapshot.projects,
  agents: fixtureIntelligenceSnapshot.agents,
  reviewItems: fixtureReviewItems,
  reviewTasks: fixtureReviewTasks,
};
...
export function getFixtureReviewSnapshot(): ReviewSnapshot {
  return cloneFixture(fixtureReviewSnapshot);
}
