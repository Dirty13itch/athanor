...
## Purpose
Cross-reference `docs/hardware/inventory.md` against node audits and architecture documents to detect discrepancies.

## Procedure
1. Read `docs/hardware/inventory.md` completely
